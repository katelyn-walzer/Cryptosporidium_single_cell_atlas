...
### This repo houses all of the code and analysis conducted for the manuscript "Transcriptional control of the *Cryptosporidium* lifecycle". A link to the raw fastq file data hosted on GEO is provided here. 
