...
#Extended Data Figure 7a-c, plot gene signatures on the life cycle
...
#No legend, Extended Data Figure 7a
...
#No legend, Extended Data Figure 7b
...
#No legend, Extended Data Figure 7c
...
#Make heatmap of all cluster markers, Extended Data Figure 4
...
#Make heatmap of all AP2 transcription factors, Extended Data Figure 8
...
#MybM cgd6_2250, Figure 4a and Extended Data Figure 9a
#No legend
...
#Plot the AP2 transcription factors, Extended Data Figure 9a
#AP2 cgd3_2970
#No legend
...
#Plot the GGCs, Extended Data Figure 7d
...
#This refers to Supplementary Table 10, male genes
...
#This refers to Supplementary Table 9, female genes
...
#Plot genes from Myb-M overexpression onto UMAP
#Plot genes that are upregulated by Myb-M overexpression
MybM_OE.genes <- list(c("cgd8-5323", 
                        "cgd5-2870",
                        "cgd3-3050",
                        "cgd5-1510",
                        "cgd3-3550",
...
seurat.integrated_1.0_new_start_scaled <- AddModuleScore(
  object = seurat.integrated_1.0_new_start_scaled,
  features = MybM_OE.genes,
  name = 'Myb.M_OE_'
)

#This is part one of Figure 4i
#No legend
FeaturePlot(seurat.integrated_1.0_new_start_scaled, features = 'Myb.M_OE_1', min.cutoff = 0, order = TRUE, pt.size = 2, cols = c("lightgray", "blue")) +
  FontSize(x.title = 20, y.title = 20) + NoLegend() + FontSize(x.title = 20, y.title = 20) + xlim(-11, 11)+ylim(-14, 8) + theme(axis.text=element_text(size = 16)) + ggtitle(NULL) +
  coord_fixed(ratio = 1)
...
#Plot genes that are downregulated by Myb-M overexpression
MybM_OE_down.genes <- list(c("cgd6-2450",
                             "cgd8-350",
                             "cgd6-4460",
                             "cgd2-3090",
                             "cgd8-4020",
...
seurat.integrated_1.0_new_start_scaled <- AddModuleScore(
  object = seurat.integrated_1.0_new_start_scaled,
  features = MybM_OE_down.genes,
  name = 'Myb.M_OE_down_'
)

#This is part two of Figure 4i
#No legend
FeaturePlot(seurat.integrated_1.0_new_start_scaled, features = 'Myb.M_OE_down_1', min.cutoff = 0, order = TRUE, pt.size = 2, cols = c("lightgray", "green3")) +
  FontSize(x.title = 20, y.title = 20) + NoLegend() + FontSize(x.title = 20, y.title = 20) + xlim(-11, 11)+ylim(-14, 8) + theme(axis.text=element_text(size = 16)) + ggtitle(NULL) +
  coord_fixed(ratio = 1)
...
#For rebuttal
#Plot genes from Matos et al., 2019 on UMAP
#Table S2 50 genes most highly expressed in oocysts/sporozoites
Matos_oocyst.genes <- list(c("Cgd2-140",
                             "cgd1-2400",
                             "cgd1-3810",
                             "cgd1-640",
                             "cgd1-880",
...
seurat.integrated_1.0_new_start_scaled <- AddModuleScore(
  object = seurat.integrated_1.0_new_start_scaled,
  features = Matos_oocyst.genes,
  name = 'Matos_oocyst_'
)

#No legend
FeaturePlot(seurat.integrated_1.0_new_start_scaled, features = 'Matos_oocyst_1', min.cutoff = 0, order = TRUE, pt.size = 2) +
  FontSize(x.title = 20, y.title = 20) + NoLegend() + FontSize(x.title = 20, y.title = 20) + xlim(-11, 11)+ylim(-14, 8) + theme(axis.text=element_text(size = 16)) + ggtitle(NULL) +
  coord_fixed(ratio = 1)
...
#Table S3 50 genes most highly expressed in trophozoites/meronts
Matos_trophozoite.genes <- list(c("cgd1-1660",
                                  "cgd1-2270",
                                  "cgd1-2880",
                                  "cgd1-300",
                                  "cgd1-3810",
...
seurat.integrated_1.0_new_start_scaled <- AddModuleScore(
  object = seurat.integrated_1.0_new_start_scaled,
  features = Matos_trophozoite.genes,
  name = 'Matos_trophozoite_'
)

#No legend
FeaturePlot(seurat.integrated_1.0_new_start_scaled, features = 'Matos_trophozoite_1', min.cutoff = 0, order = TRUE, pt.size = 2) +
  FontSize(x.title = 20, y.title = 20) + NoLegend() + FontSize(x.title = 20, y.title = 20) + xlim(-11, 11)+ylim(-14, 8) + theme(axis.text=element_text(size = 16)) + ggtitle(NULL) +
  coord_fixed(ratio = 1)
...
#Plot oocyst wall genes (LOPIT dataset) on life cycle
oocyst.wall.genes <- list(c("cgd1-3550",
                            "cgd1-800",
                            "cgd2-1590",
                            "cgd2-2510",
                            "cgd2-3040",
...
seurat.integrated_1.0_new_start_scaled <- AddModuleScore(
  object = seurat.integrated_1.0_new_start_scaled,
  features = oocyst.wall.genes,
  name = 'oocyst_wall_'
)

#No legend, for rebuttal letter
FeaturePlot(seurat.integrated_1.0_new_start_scaled, features = 'oocyst_wall_1', min.cutoff = 0, order = TRUE, pt.size = 2) +
  FontSize(x.title = 20, y.title = 20) + NoLegend() + FontSize(x.title = 20, y.title = 20) + xlim(-11, 11)+ylim(-14, 8) + theme(axis.text=element_text(size = 16)) + ggtitle(NULL) +
  coord_fixed(ratio = 1)
...
#FindAllMarkers for in vivo versus in vitro
in_vivo_in_vitro_markers <- FindAllMarkers(seurat.integrated_1.0_new_start_scaled, assay = "RNA", only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
in_vivo_in_vitro_markers %>% group_by(cluster) %>% top_n(n = 2, wt = avg_logFC)

#Differentially expressed genes between in vitro and in vivo samples
write_tsv(in_vivo_in_vitro_markers, "2022_12_20_in_vivo_in_vitro_markers_markers_CryptoDBver46_33PCs_RNA")


#Pick out cells at 24 hours clustering with male or female
Idents(seurat.integrated_1.0_new_start_scaled) <- "orig.ident"

#Set UMAP to 24hrs asexual only to pick correct parasites
orig.ident24hrs <- subset(seurat.integrated_1.0_new_start_scaled, idents = "crypto_24hrs")

DimPlot(orig.ident24hrs)

#Select "male" parasites
UMAP_plot <- DimPlot(orig.ident24hrs)
select.cells.24hrs.male <- CellSelector(plot = UMAP_plot)

#These are the "male" barcodes
print(select.cells.24hrs.male)


#Select "female" parasites
UMAP_plot <- DimPlot(orig.ident24hrs)
select.cells.24hrs.female <- CellSelector(plot = UMAP_plot)

#These are the "female" barcodes
print(select.cells.24hrs.female)
